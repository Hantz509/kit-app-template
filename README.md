...
After launching the USD viewer app you need web app to visualize it through a web browser: clone this repo: git clone https://github.com/Hantz509/web-viewer-sample.git
